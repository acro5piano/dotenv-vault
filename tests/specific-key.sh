...
testcase_encrypt_specific_key_with_regex() {
    bin/dotenv-vault -e 'API_KEY|INCLUDE_EQUAL_KEY' -k foobarbaz encrypt tests/assets/dotenv > /tmp/dotenv.encrypted
...
testcase_decrypt_specific_key() {
    bin/dotenv-vault -e 'API_KEY|INCLUDE_EQUAL_KEY'  -k foobarbaz encrypt tests/assets/dotenv > /tmp/dotenv.encrypted-asset
    bin/dotenv-vault -e 'API_KEY|INCLUDE_EQUAL_KEY'  -k foobarbaz decrypt /tmp/dotenv.encrypted-asset > /tmp/dotenv.decrypted
